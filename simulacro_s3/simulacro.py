...
# Como gerente de una librería, quiero un sistema que me permita gestionar el inventario de libros de manera eficiente, 
# para que pueda realizar un seguimiento preciso de los títulos disponibles, su cantidad y los precios actualizados.
# Además, quiero poder calcular el valor total del inventario para saber cuánto dinero está invertido en los productos.
